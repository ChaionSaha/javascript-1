...
/////////////////////////////////////
// Users containing at least 50 points
...
{
    console.log(`Full Name: ${d.firstName} ${d.lastName}\nPoint: ${d.point}\nCompany Name: ${d.company}`);
...
console.log("Finding the point of a user whose email is 'Tristian7@yahoo.com'. Display the point and list the users containing that point and display their email addresses.");
var find;
